...
Class.prototype.indicator = function() {
  ...
  // 模板
  let tplInd = that.elemInd = $(['<div class="' + ELEM_IND + '"><ul>',
    (function() {
      let li = []
...
Class.prototype.slide = function(type, num) {
  ...
  let elemItem = that.elemItem

  let options = that.config

  let thisIndex = options.index

  let filter = options.elem.attr('lay-filter')
